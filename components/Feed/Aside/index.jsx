      ...
      <aside className="flex flex-col space-y-4">
              ...
              <div className="flex flex-col w-full space-y-2">
                ...
                <div className="space-y-2">
                  {profile?.social?.twitter && (
                    <Link
                      className="flex items-center space-x-2 text-xs text-[#00acee]"
                      href={`https://twitter.com/${profile.social.twitter}`}
                    >
                      <IoLogoTwitter className="h-6 w-6" />
                      <span>https://twitter.com/{profile.social.twitter}</span>
                    </Link>
                  )}
                  {profile?.social?.instagram && (
                    <Link
                      className="flex items-center space-x-2 text-xs text-[#DD2A7B]"
                  ...
                  {profile?.social?.facebook && (
                    <Link
                      className="flex items-center space-x-2 text-xs text-[#3b5998]"
        ...
        {!user && (
          <div className="bg-white dark:bg-neutral-900 shadow p-4 sm:rounded-xl overflow-hidden">
            <span className="text-lg font-semibold">Siga algumas pessoas</span>
